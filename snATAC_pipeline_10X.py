...
def process_args():
	...
	matrix_group.add_argument('--minimum-frip', required=False, type=float, default=0.4, help='Minimum frip for barcode inclusion')
	...
	matrix_group.add_argument('--blacklist-file', required=False, type=str, default='/home/joshchiou/references/ENCODE.hg19.blacklist.bed', help='BED file of blacklisted regions')
